...
/**
 * A class that represents an item for use in the Knapsack-Packing Problem.
 * Every item has a name, weight, and value. Items are immutable.
 * 
 * Items are comparable based on weight from lightest to heaviest.
 * 
