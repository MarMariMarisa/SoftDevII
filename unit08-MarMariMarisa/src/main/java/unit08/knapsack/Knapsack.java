...
/**
 * A knapsack that may be packed with zero or more {@link Item Items}. Each 
 * item has a weight and a value. The goal is to pack the items with the
 * greatest total value without exceeding the knapsack's weight.
 * 
